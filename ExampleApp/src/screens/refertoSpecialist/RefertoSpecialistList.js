...
export default class RefertoSpecialistList extends Component {
                    ...
                    <ImageBackground style={[
                        ...
                        <View style={
                            ...
                            <Text
                                ...
                                <Text style={[CommonStyles.fontRegular, CommonStyles.textSizeSmall]}>It is a list of all your Referred Specialists </Text>
                            </Text>
                        </View>
                        ...
                        <View style={{ flex: 8 }}>
                            <FlatGrid
                                itemDimension={350}
                                items={this.state.refertoSpecialistList}
                                spacing={15}
                                ...
                                renderItem={({ item }) => (
                                    ...
                                    <View style={[CommonStyles.container, CommonStyles.shadow, CommonStyles.br5, CommonStyles.bgColor]}>
                                        ...
                                        <ImageBackground
                                            ...
                                            <TouchableOpacity style={[CommonStyles.container, { flexDirection: 'row', padding: 12 }]} onPress={() => { this.addDiagnosis(item) }}>
