                    ...
                    <ImageBackground style={CommonStyles.backgroundImage} source={require('../../assets/drawable-xhdpi/bwback.png')}>
                        ...
                        <ScrollView style={[styles.View2, { marginTop: 33, alignSelf: 'center', width: '86%', backgroundColor: '#fff', borderRadius: 5,}]}>
                            ...
                            <TouchableOpacity style={{ marginVertical: 20 }}>
                                <Icon name="user-circle-o" type="font-awesome" size={100} color="#303030"/>
                            ...
                            <Item stackedLabel style={styles.itemStyle}>
                                <Label style={[{ color: '#333333' }, CommonStyles.DINProLight, CommonStyles.textSizeSmall]} >First Name</Label>
                                <Input />
                            </Item>


                            <Item stackedLabel style={[styles.itemStyle, { marginBottom: 5 }]} >
                                <Label style={[{ color: '#333333' }, CommonStyles.DINProLight, CommonStyles.textSizeSmall]} >Last Name</Label>
                                <Input  />
                            </Item>

                            <Item stackedLabel style={[styles.itemStyle, { marginBottom: 5 }]} >
                                <Label style={[{ color: '#333333' }, CommonStyles.DINProLight, CommonStyles.textSizeSmall]} >Father Name</Label>
                                <Input  />
                            </Item>

                            <Item stackedLabel style={[styles.itemStyle, { marginBottom: 5 }]} >
                                <Label style={[{ color: '#333333' }, CommonStyles.DINProLight, CommonStyles.textSizeSmall]} >Address</Label>
                                <Input  />
                            </Item>

                            <Item stackedLabel style={[styles.itemStyle, { marginBottom: 150}]} >
                                <Label style={[{ color: '#333333' }, CommonStyles.DINProLight, CommonStyles.textSizeSmall]} >Postal Code</Label>
                                <Input  />
                            </Item>
                            </ScrollView>
