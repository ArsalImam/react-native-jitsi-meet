      ...
      <View style={[CommonStyles.container]}>
        ...
        <ImageBackground
          ...
          <KeyboardAwareScrollView
            ...
            <View style={[CommonStyles.container, {}]}>
              <View style={{ flex: 0.4, flexDirection: "row", marginTop: 25}}>
                ...
                {/* <View
                  ...
                  <View
                    style={[{ marginRight: 10, flex: 0.5, justifyContent: 'flex-end',marginTop: 5,paddingTop:10 }]}>
                    {this.state.user.imageUrl != '' ? (
                      <Image
                        style={{
                          // height: 53,
              ...
              <View style={{ flex: 1, justifyContent: 'flex-end' }}>
                <View
                  ...
                  {/* <View style={[CommonStyles.container, {}]}> */}
                  <Image
                    style={[CommonStyles.container, { resizeMode: 'contain', alignSelf: 'flex-end', justifyContent: 'flex-end' }]}
