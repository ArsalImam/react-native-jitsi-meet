                    ...
                    <View style={
                        { flex: 3, backgroundColor: '#297dec' }
                            ...
                            <Text style={{ color: '#FFFFFF', paddingLeft: 17, marginTop: 65 }}>
                                ...
                                <Text style={[CommonStyles.fontRegular, CommonStyles.textSizeSmall]}>It is a list of all your Illustrations </Text>
                            </Text>
                        </View>
                                ...
                                renderItem={({ item }) => (
                                    ...
                                    <View style={[CommonStyles.container, CommonStyles.shadow, CommonStyles.br5, CommonStyles.bgColor]}>
                                        ...
                                        <ImageBackground
                                            ...
                                            <TouchableOpacity style={[CommonStyles.container, { padding: 12, flexDirection: 'row' }]}
