                ...
                <ImageBackground
                    ...
                    <View style={styles.View2}>
                        <ScrollView
                            ...
                            <Item style={[CommonStyles.container, CommonStyles.itemStyle,{paddingTop:40}]}>
                                <DatePicker
                    ...
                    {this.state.startTimeText}
                                    ...
                                    <Text style={[CommonStyles.fontRegular, CommonStyles.textSizeAverage, {
                                        paddingTop: 30,
                                        marginLeft: -100
                                    }]}>
                                        {this.state.startTimeText}
                    ...
                    {this.state.endTimeText}
                            ...
                            <View
                                ...
                                <Item
                                    stackedLabel
                                    style={{width: '45%'}}>
                                    <Label style={[CommonStyles.fontRegular, CommonStyles.textSizeAverage,]}>Number of
                                        Weeks</Label>
                                    <Input
                                        name="clinics"
                                ...
                                <Item stackedLabel style={{width: '45%'}}>
                                    ...
                                    <Input value={this.state.clinicTitle}
                            ...
                            <Item
                                picker
                                style={[CommonStyles.container, CommonStyles.itemStyle,{paddingTop:20}]}>
                                <Picker
                                    mode="dropdown"
