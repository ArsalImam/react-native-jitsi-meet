                    ...
                    <ImageBackground style={[
                        ...
                        <View style={
                            ...
                            <Text style={[CommonStyles.fontRegular, CommonStyles.headingTextStyle]}>
                                <Text style={[CommonStyles.textSizeLarge, CommonStyles.textColorWhite]} >{`View Scanned Medical Records\n`}</Text>
                                <Text style={[CommonStyles.textSizeSmall, CommonStyles.textColorWhite]}> </Text>
                            </Text>
                        </View>
