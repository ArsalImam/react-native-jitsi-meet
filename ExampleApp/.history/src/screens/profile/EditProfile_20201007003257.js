...
export default class UploadIllustrations extends React.Component {
  ...
  componentWillMount() {
    console.warn('imageeeeeeee', this.state.user);
  }
  ...
  saveImage = () => {
    ...
    console.warn('date of birth', data)
            ...
            <KeyboardAwareScrollView
              ...
              style={[
                ...
                <DatePicker
                  ...
                  intialValue={moment(this.state.dateOfBirth).format('LT')}
