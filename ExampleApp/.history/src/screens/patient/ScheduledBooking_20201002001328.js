...
console.warn("Ammad----v",)
  ...
  (
    // AppointmentStatus.scheduled, true,moment().format('YYYY-MM-DD') ,moment().add(7, 'days').format('YYYY-MM-DD') 
     )
...
coming15days(){
  ...
  Api.instance()
   .getMyAppointmentsComing15Days(
    //  AppointmentStatus.scheduled, true, moment().format('YYYY-MM-DD') ,moment().add(15, 'days').format('YYYY-MM-DD') 
     )
