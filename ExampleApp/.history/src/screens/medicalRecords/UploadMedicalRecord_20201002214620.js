...
export default class UploadMedicalRecord extends Component {
  ...
  _savePatientHistory = () => {
    ...
    if (this.state.imageUri == '') {
      ViewUtils.showAlert('Please Provide Image');
      return;
    } else if (this.state.name.trim() == '') {
      ViewUtils.showAlert('Please Provide name');
      return;
    }else if (this.state.vitalType.trim() == '') {
      ViewUtils.showAlert('Please Provide Document Type');
      return;
    }
